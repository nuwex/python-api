...
s = 'http://api.wunderground.com/api/AddAPIKeyHere/geolookup/conditions/q/' + var + '/' + var1 + '.json'
f = urllib2.urlopen(s)
json_string = f.read()
...
t = 'http://api.wunderground.com/api/AddAPIKeyHere/geolookup/astronomy/q/' + var + '/' + var1 + '.json'
g = urllib2.urlopen(t)
json_string = g.read()
parsed_json = json.loads(json_string)
location = parsed_json['location']['city']
...
u = 'http://api.wunderground.com/api/AddAPIKeyHere/planner_' + var2 + var3 + '/q/' + var + '/' + var1 + '.json'
h = urllib2.urlopen(u)
json_string = h.read()
parsed_json = json.loads(json_string)
